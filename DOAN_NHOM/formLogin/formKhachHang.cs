    ...
    public partial class formKhachHang : Form
    {
        ...
        private void InitAdapter()
        {
            ...
            try
            {
                ...
                adapter.InsertCommand.Parameters.Add("@MAKH", SqlDbType.VarChar, 10, "MAKH");
                adapter.InsertCommand.Parameters.Add("@TENKH", SqlDbType.NVarChar, 50, "TENKH");
                adapter.InsertCommand.Parameters.Add("@SDT", SqlDbType.VarChar, 20, "SDT");
                adapter.InsertCommand.Parameters.Add("@DIACHI", SqlDbType.NVarChar, 100, "DIACHI");
                ...
                adapter.UpdateCommand.Parameters.Add("@TENKH", SqlDbType.NVarChar, 50, "TENKH");
                adapter.UpdateCommand.Parameters.Add("@SDT", SqlDbType.VarChar, 20, "SDT");
                adapter.UpdateCommand.Parameters.Add("@DIACHI", SqlDbType.NVarChar, 100, "DIACHI");
                var pr2 = adapter.UpdateCommand.Parameters.Add(new SqlParameter("@MAKH", SqlDbType.VarChar) { SourceColumn = "MAKH" });
