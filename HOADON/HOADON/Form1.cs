...
namespace HOADON
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            makm.Load(dta);
            cbbkhuyenmai.DataSource = makm;
            cbbkhuyenmai.DisplayMember = "KHUYENMAI";
        ...
        private void btnadd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (Kiemtra())
                {
                    ...
                    command.Parameters.Add("@KHUYENMAI", SqlDbType.Float).Value = Convert.ToDouble(cbbkhuyenmai.Text);
        ...
        private void dtgv_Product_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cbbkhuyenmai.Text = Convert.ToString(row.Cells["KHUYENMAI"].Value);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataView.RowFilter = String.Format("MAHD like '%{0}%' or MANV like '%{1}%' or MAKH like'%{2}%'", txt_Search.Text, txt_Search.Text, txt_Search.Text);
